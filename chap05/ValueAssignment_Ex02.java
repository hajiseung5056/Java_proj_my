...
public class ValueAssignment_Ex02 {
	public static void main(String[] args) {
		...
		// 배열의 원소값을 대입하는 방법 2 : 배열의 넣을 초기 값을 알 때 사용
		int[] array3 = new int[] {6,7,8,9,10};   // 배열 변수 선언과 동시에 값할당. 이경우에는 방크기에 값을 선언하면안됨
		...
		// 배열의 원소 값을 대입하는 방법 3
		int[] array5 = {11,12,13};  // 선언과 값할당을 함께 할경우 new int 생략 가능
		System.out.println(array5[0] + " " + array5[1] + " " + array5[2]);
		
		/* 선언은 한 후에 값을 할당할경우 new int를 생략하면 오류발생
		int[] array6;
		array6 = {11,12,13};
