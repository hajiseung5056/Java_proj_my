...
public class MethodOfString {
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a',8));      // 8번방에서부터 오른쪽으로 검색 시작 // 9
		System.out.println(str1.lastIndexOf('a',8));  // 8번방에서부터 왼쪽으로 검색 시작 // 7
		...
		System.out.println(str1.lastIndexOf("bye"));  // <<중요>>해당값이 없는경우 : -1 출력 
		System.out.println();
		
		// 3. 문자열 변환 몇 연결 (String.valueOf, concat())
		// String.valueOf(기본자료형) : 기본자료형을 String으로 변환
		String str3 = String.valueOf(2.3);     // 실수 2.3 을 String 형으로 변환
		String str4 = String.valueOf(false);   // boolean 타입 false 를 String 형으로 변환
		...
		// concat() method 에서 String.valueOf() 사용  // + : 자동으로 타입변환
		String str6 = "안녕" + 3;  // 안녕3 // + 연산자를 사용하면 3이 String타입으로 자동변환
		String str7 = "안녕".concat(String.valueOf(3)); // String.valueOf(3)을 사용하여 int3을 String타입으로 변환
