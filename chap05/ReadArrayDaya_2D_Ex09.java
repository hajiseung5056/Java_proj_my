package chap05;
public class ReadArrayDaya_2D_Ex09 {
	public static void main(String[] args) {
		// . 2차원 데이터 배열의 길이
		int[][] array1 = new int [2][3];
		System.out.println(array1.length);    // 2차원 배열인 경우  //  배열변수.length       : 행의 갯수를 출력 
		                                                        //배열변수[행의번호].length : 열의 갯수를 출력
		System.out.println(array1[0].length); // 0번행의 열의 갯수    
		System.out.println(array1[1].length); // 1번행의 열의 갯수
		...
		System.out.println(array2[1].length);      //3 (1번행의 열의갯수)
		System.out.println("==================");
		// 배열의 인덱스 번호로 출력하는 방법
		...
		System.out.println("====================");
		for (int[] array : array2) {               // 2차원 배열의 행의 값을 변수에 1차원 배열 변수에 담고 (array)
